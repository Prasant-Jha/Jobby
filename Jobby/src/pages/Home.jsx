  ...
  return (
    <div className="overflow-hidden">
      ...
      <div className="flex flex-wrap items-center justify-evenly min-h-[92vh] bg-gradient-to-r from-blue-500 to-indigo-600">
        <div className="flex flex-col justify-center space-y-6 text-white max-w-[50%]">
          ...
          <button className="h-[45px] w-[180px] sm:w-[220px] bg-blue-600 border-2 text-white text-lg font-semibold rounded-md hover:bg-blue-700 transition duration-300" onClick={() => navigate("/login")}>
            Get Started
          </button>
        </div>
        <div className="hidden md:block lg:w-1/2 xl:w-1/3 max-w-[40%]">
          <img
            src={JobImage}
            alt="Job search"
            className="w-[80%] h-auto object-cover rounded-lg shadow-lg transform transition-transform duration-300 hover:scale-105"
          />
        </div>
      </div>
    </div>
